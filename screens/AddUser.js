...
const AddUser = ({ navigation }) => {
	...
	const roles = ["subscriber", "author", "editor", "admin", "maintainer"];
	const statuses = ["pending", "active", "active"];
	...
	const handleImagePicker = async () => {
		...
		if (imgData.success) {
			...
			ToastAndroid.show("Image added", ToastAndroid.SHORT, ToastAndroid.CENTER);
		}
	...
	const handleSubmit = async () => {
		...
		// TODO::Status CHECK
		if (!status) {
			Alert.alert("Invalid Status", "Status should not be empty");
			return;
		}
		// TODO::Status CHECK
		if (!role) {
			Alert.alert("Invalid Role", "Role should not be empty");
			return;
		}
		...
		try {
			...
			if (response.ok) {
				...
				console.log(data);
				setUsers((prev) => [{ ...data, username: data.name }, ...prev]);
				ToastAndroid.show(
					"Users added",
					ToastAndroid.SHORT,
					ToastAndroid.CENTER
	...
	return (
		<KeyboardAvoidingView style={styles.container}>
			<ScrollView contentContainerStyle={styles.contentContainer}>
				...
				<Select data={roles} setItem={setRole} title="Select Role" />
				<Select data={statuses} setItem={setStatus} title="Select Status" />
